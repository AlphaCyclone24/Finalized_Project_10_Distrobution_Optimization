...
SAMPLE_SPREADSHEET_ID = '1UI6E7Eg-nukPCZSbBtP4ga-nNqCRYO97VW3t40403zU'
...
def confirmation_screen():
    ...
    confirmation_label = Label(confirmation_window, text=f"Your order has been submitted", bg="#CF9FFF", fg="white", font=("yu gothic ui", 13, "bold"))
    confirmation_label.place(x=10, y=300)

def updatespreadsheet():
    RAW_DATA = [deliverymonth], [deliveryday], [deliveryyear], [hour], [minute], [TOD], [text_location], [amount], [final_estimate]

    global request
    request = sheet.values().append(spreadsheetId=SAMPLE_SPREADSHEET_ID,
                                    range="RAW!A2:I2", valueInputOption="USER_ENTERED", body={"values":RAW_DATA}).execute()
